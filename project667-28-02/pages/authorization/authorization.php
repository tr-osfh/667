...
<body>
    ...
    ?>
                <div class="message">
                    ...
                    <a href="http://localhost/project667-28-02/index.php"><button>Домой</button></a>
                </div>
            <?php
            ...
            ?>
                <div class="message">
                    ...
                    <a href="http://localhost/project667-28-02/pages/authorization/authorization.html"><button>Назад</button></a>
                </div>
            <?php
            }
        } else {
