...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/project667-28-02/static/styles/styleForLK.css">
...
<body>
    ...
    <div class="header_container" id="header">
        <!-- Логотип в шапке -->
        <a href="http://localhost/project667-28-02/index.php" onclick="location.href='index.php';" class="icon_button"></a>
